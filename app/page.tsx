...
export default function Home() {
  ...
  const setThemeCss = (color: string) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-[100%] h-[100%]">
      <div className="bg-card max-w-[366px] border-2 border-border rounded-lg p-8">
        ...
        {theme && <span className="text-copy-primary">The current theme is: {theme}</span>}
      ...
      <div className="flex max-w-[366px] gap-1">
        ...
        <button
          className="mt-4 bg-cta p-2"
          onClick={() => setTheme("catpuccin")}
        >
          switch to catpuccin
        </button>
